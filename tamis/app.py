"""Application bootstrap for Tamis."""
...
from tamis.main_window import MainWindow
...
LOG_PATH = Path.home() / ".tamis" / "tamis.log"
    ...
    def handle_exception(exc_type, exc_value, exc_traceback):
        ...
        try:
            QMessageBox.critical(
                None,
                "Unexpected Error",
                "Tamis hit an unexpected error and may be in an inconsistent state -- "
